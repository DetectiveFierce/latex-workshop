...
\definecolor{codecommentcolor}{RGB}{156, 156, 156}
\definecolor{dark}{HTML}{83B02F}
\definecolor{light}{HTML}{e1f0c7}

% Pure LaTeX code styling, replacing Pandoc/knitr token hooks.
\definecolor{shadecolor}{RGB}{252,249,236}
\lstdefinestyle{templatecode}{
  backgroundcolor=\color{shadecolor},
  basicstyle=\footnotesize\ttfamily,
  keywordstyle=\color{mygreen}\bfseries,
  commentstyle=\color{codecommentcolor}\itshape,
