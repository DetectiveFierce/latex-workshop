...
const envSchema = z.object({
  ...
  COMPILE_TIMEOUT_MS: positiveInteger.default(60_000),
  MAX_PROJECTS_PER_USER: positiveInteger.default(250),
  MAX_USER_BYTES: positiveInteger.default(1_073_741_824),
